...
const EditNotePage = ({ match, history, dispatchCreateNoteAction, dispatchUpdateNoteAction, dispatchGetNoteByIdAction }) => {
    ...
    const isFormInvalid = () => (!title.trim() || !content.trim() | !description.trim() || !category.trim())
